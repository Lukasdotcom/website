$(document).ready(function() {
    if (localStorage.cookies_accept != "true") {
        ...
        div.innerHTML = `<div class='popup-content'>
                            ...
                            This website also uses matomo you may disable matomo analytics by clicking this <a href="https://analytics.lschaefer.xyz/index.php?module=CoreAdminHome&action=optOut&language=en&backgroundColor=000000&fontColor=ffffff&fontSize=17px&fontFamily=" target="_blank" rel="noopener noreferrer" >link</a> and unchecking the check box.</p>
