...
<body>
    ...
    <span style="border-width:3px;border-style:solid;padding:5px;border-color:green;">javascript:var script = document.createElement('script');
    script.src = "<?php
    // Will echo out the hostname
    echo $_SERVER["REQUEST_SCHEME"] . '://' . $_SERVER["HTTP_HOST"];?>
    /cookieClicker/index.js";
    document.head.appendChild(script);</span>
